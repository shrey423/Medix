        ...
        <footer className="m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:pt-36">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="/Medix/public" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <Logo/>
          ...
          © {new Date().getFullYear()} <a href="/Medix/public" className="hover:underline text-black">medix™</a>. All Rights Reserved.
        </span>
            </div>
        </footer>
    );
